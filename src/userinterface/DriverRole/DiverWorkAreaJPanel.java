 ...
 * @author raunak
 */
public class DiverWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private UserAccount userAccount;
    private CarPoolOrganization labOrganization;
    
    /**
     * Creates new form DiverWorkAreaJPanel
     */
    public DiverWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        initComponents();
        
        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.labOrganization = (CarPoolOrganization)organization;
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : labOrganization.getWorkQueue().getWorkRequestList()){
            ...
            row[0] = ((CustomerWorkRequest)request);
            row[1] = ((CustomerWorkRequest)request).getSender().getEmployee().getName();
            row[2] = ((CustomerWorkRequest)request).getReceiver() == null ? null : ((CustomerWorkRequest)request).getReceiver().getEmployee().getName();
            row[3] = ((CustomerWorkRequest)request).getStatus();
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Source", "Customer", "Driver", "Status", "Destination"
            }
        ) {
